...
// import type { Market, AIGeneratedMarket } from "@/types/market"
...
//                     <HomePage markets={markets} loading={loading} onMarketsUpdate={loadMarkets} />
//                   </main>
//                   <Navigation />
//                 </div>
//               </>
...
//                 <div className="flex flex-col min-h-screen">
//                   <main className="flex-1 pb-20">
//                     <MarketsPage markets={markets} loading={loading} />
//                   </main>
//                   <Navigation />
//                 </div>
//               </>
...
//                 <div className="flex flex-col min-h-screen">
//                   <main className="flex-1 pb-20">
//                     <CreateMarketPage onMarketCreated={addMarket} />
//                   </main>
//                   <Navigation />
//                 </div>
//               </>
...
function AppContent() {
  ...
  const loadMarkets = async () => {
    try {
      ...
      setMarkets(deduplicateMarkets(demoMarkets))
    } catch (error) {
      console.error("Error loading markets:", error)
      toast({
        title: "❌ Loading Failed",
